...
<div id="top"> 
      ...
      <!--  <nav id="mainNav" class="navbar navbar-collapse navbar-collapse-center" > -->
      	    <div id="mainNav" class="collapse navbar-collapse navbar-collapse-center">
				<ul class="nav nav-tabs navbar-center " >
				  ...
				  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="shopcart/cartindex.php">購物專區<span class="caret"></span></a>
										<ul class="dropdown-menu">
	...
	<footer id="footer"> 
		<table id="footerTb" width="40%" height="50" >
		  <tbody>
			<tr>
				<td><a href="sitemap.html">網站地圖</a></td>
			  	<td><a href="https://www.facebook.com/lwcupcake/">官方粉絲團</a></td>
				<td><a href="traffic.html">交通資訊</a></td>
