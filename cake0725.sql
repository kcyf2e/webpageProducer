...
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='產品檔';
...
--
ALTER TABLE `orderdetail`
  MODIFY `OrderDetailID` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- 使用資料表 AUTO_INCREMENT `orders`
--
ALTER TABLE `orders`
  MODIFY `OrderID` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
